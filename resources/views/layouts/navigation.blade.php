        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->role === 'admin' ? route('admin.dashboard') : route('tenant.dashboard') }}">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 transition ease-in-out duration-150">
                            <div class="font-bold {{ Auth::user()->role === 'admin' ? 'text-blue-800' : 'text-gray-800' }}">
                                {{ Auth::user()->name }} {{ Auth::user()->role === 'admin' ? '(Admin)' : '' }}
                            </div>
                            <div class="ms-1">
